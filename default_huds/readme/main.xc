...
function @page($p:number,$s:panel)
	$s.text_size(1)
	if $p == 1
		@keyboardKeys(-270,16-65,"Alt",$s)
		@keyboardKeys(-270,76-65,"Esc",$s)
		@keyboardKeys(-270,136-65,"Enter",$s)
		$s.text_align(center)
		$s.write(0,-105,color(0,200,200),"Essential shortcuts")
		$s.text_align(left)
		$s.write(80,30-65,color(200,200,200),"To release the cursor, use the left ALT key.\n- Quick press: Toggle mode\n- Hold: Temporary mode")
		$s.write(80,89-65,color(200,200,200),"Hold to exit the game")
		$s.write(90,149-65,color(200,200,200),"Toggle chat window")
	elseif $p == 2
